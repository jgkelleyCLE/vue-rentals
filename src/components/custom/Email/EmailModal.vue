...
<template>
  <Dialog>
    <DialogTrigger class="w-full">
      <button class="bg-blue-500 hover:bg-blue-600 transition duration-300 p-2 rounded-md w-full text-white">
        Submit Quote
      </button>
    </DialogTrigger>
    <DialogContent class="">
      ...
      <form class="w-full flex flex-col items-start gap-2" @submit="submitHandler">
        <div class="flex flex-col w-full">
          ...
          <input
            ...
            name="name"
            v-model="title"
            class="w-full p-2 rounded-md text-gray-700 font-bold border-2 border-gray-300"
        ...
        <button
          type="submit"
          class="w-full bg-safariGreen hover:bg-safariGreenHover transition duration-300 p-2 rounded-md text-white font-bold"
        >
          Submit
        </button>
      </form>
