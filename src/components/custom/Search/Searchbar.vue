  ...
  <div class="flex items-center justify-center w-[95%] max-w-[600px]">
    <form class="flex items-center w-full" @submit="handleSearchSubmit">
      <input
        ...
        class="p-3 rounded-l-md text-gray-700 placeholder-gray-600 text-2xl bg-white/60 outline-none h-12 z-0 w-[95%]"
      />
      <button
        aria-label="Submit Search"
        type="submit"
        class="flex items-center gap-2 rounded-r-md bg-white p-3.5"
        title="Search"
      >
